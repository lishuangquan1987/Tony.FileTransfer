...
namespace Tony.FileTransfer.Server {
  public static partial class IFileUpload
  {
    ...
    static readonly grpc::Marshaller<global::Tony.FileTransfer.Server.CheckFileExistRequest> __Marshaller_fileupload_CheckFileExistRequest = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Tony.FileTransfer.Server.CheckFileExistRequest.Parser.ParseFrom);
    static readonly grpc::Marshaller<global::Tony.FileTransfer.Server.CommonResponse> __Marshaller_common_CommonResponse = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Tony.FileTransfer.Server.CommonResponse.Parser.ParseFrom);
    static readonly grpc::Marshaller<global::Tony.FileTransfer.Server.UploadWithStreamRequest> __Marshaller_fileupload_UploadWithStreamRequest = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Tony.FileTransfer.Server.UploadWithStreamRequest.Parser.ParseFrom);
